...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void setUpBaseView() {
        ...
        EaseUser me = EaseUI.getInstance().getUserProfileProvider().getUser(EMClient.getInstance().getCurrentUser());
        EaseUser from = EaseUI.getInstance().getUserProfileProvider().getUser(message.getFrom());
        Log.e("TAG", "-----------" + me.getNickname() + "   " + me.getAvatar());
        //set nickname and avatar
        if (message.direct() == Direct.SEND) {
            // EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
            Glide.with(getContext()).load(me.getAvatar()).into(userAvatarView);
        } else {
//            EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView);
//            EaseUserUtils.setUserNick(message.getFrom(), usernickView);
            Glide.with(getContext()).load(from.getAvatar()).into(userAvatarView);
            usernickView.setText(from.getNickname());
        }
