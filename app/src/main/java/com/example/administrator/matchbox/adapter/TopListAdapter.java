...
public class TopListAdapter extends ListItemAdapter<PushBean> {

    public TopListAdapter(Context context, List<PushBean> list) {
        super(context, list);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = View.inflate(getContext(), R.layout.item_list_fans, null);
