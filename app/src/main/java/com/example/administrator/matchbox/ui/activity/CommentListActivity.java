...
import com.example.administrator.matchbox.adapter.CommentListAdapter;
...
public class CommentListActivity extends BaseActivity implements PullToRefreshBase.OnRefreshListener2<ListView>, AdapterView.OnItemClickListener {
    ...
    private void doRequest() {
        mList = PushUtils.getPushBeanByType(PushBean.TYPE_COMMENT);
        ...
        CommentListAdapter adapter = new CommentListAdapter(getBaseContext(), mList);
